...
By default user sessions are still stored in the database using the database storage backend, but the former table `fe_session_data` is now obsolete and therefore removed.
